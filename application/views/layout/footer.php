        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-slate-400">
                    <li><a href="#" data-section="persyaratan"
                            class="nav-link hover:text-white transition-colors">Persyaratan</a></li>
                    <li><a href="#" data-section="kuota"
                            class="nav-link hover:text-white transition-colors">Ketersediaan Kuota</a></li>
                    <li><a href="#" data-section="pengiriman"
                            class="nav-link hover:text-white transition-colors">Pengiriman Berkas</a></li>
...
<!-- JavaScript for Navigation and Dark Mode -->
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (sidebarToggle) {
            sidebarToggle.addEventListener('click', function () {
                ...
                if (sidebarOpen) {
                    ...
                    // Shift floating buttons to the right when sidebar opens
                    if (floatingButtons) {
                        floatingButtons.style.left = '304px'; // sidebar width (288px) + gap (16px)
                    }
                } else {
                    ...
                    // Reset floating buttons position
                    if (floatingButtons) {
                        floatingButtons.style.left = '16px'; // original left-4 = 1rem = 16px
                    }
                }
            });
        }
        ...
        if (sidebarOverlay) {
            sidebarOverlay.addEventListener('click', function () {
                ...
                // Reset floating buttons position
                if (floatingButtons) {
                    floatingButtons.style.left = '16px';
                }
            });
        }
